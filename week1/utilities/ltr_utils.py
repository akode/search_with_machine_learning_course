...
def create_rescore_ltr_query(user_query: str, query_obj, click_prior_query: str, ltr_model_name: str,
                             ltr_store_name: str,
                             active_features: t.List[str]=None, # an array of strings
...
def create_feature_log_query(query, doc_ids: t.List[str], click_prior_query, featureset_name, ltr_store_name, size=200, terms_field="_id"):
    ##### Step 3.b:
